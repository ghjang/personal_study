...
```sql
SELECT TRUE FROM DUAL;   -- 'ORA-00904: "TRUE" 부적합한 식별자'
SELECT FALSE FROM DUAL;  -- 'ORA-00904: "FALSE" 부적합한 식별자'
...
*NOTE: (적어도) 오라클 SQL의 'SELECT'절에서 boolean 타입의 처리는 직접적으로는 불가능한 것 같다(?)*
